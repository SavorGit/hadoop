...
//            scan.setCacheBlocks(false);
            ...
            SingleColumnValueFilter typefilter = new SingleColumnValueFilter(Bytes.toBytes(columnFamily),
                    Bytes.toBytes("mda_type"), CompareFilter.CompareOp.EQUAL,new BinaryComparator(Bytes.toBytes("vod")));
            SingleColumnValueFilter optionfilter = new SingleColumnValueFilter(Bytes.toBytes(columnFamily),
