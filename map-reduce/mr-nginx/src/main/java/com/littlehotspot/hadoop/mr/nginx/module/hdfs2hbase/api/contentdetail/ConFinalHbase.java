 ...
 * 手机日志
 */
public class ConFinalHbase extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        try {
            ...
            Job job = Job.getInstance(this.getConf(), ConFinalHbase.class.getSimpleName());
            job.setJarByClass(ConFinalHbase.class);
