 ...
 */
public class SmSYSToHbase2 extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        try {
            ...
            Job job = Job.getInstance(this.getConf(), SmSYSToHbase2.class.getSimpleName());
            job.setJarByClass(SmSYSToHbase2.class);
            ...
            HTable hTable = new HTable(this.getConf(), "small_system_index-log");
    ...
    private static class ProbeHbaseMapper extends Mapper<LongWritable, Text, ImmutableBytesWritable, Put> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            Long l = Long.valueOf(timestamps);
