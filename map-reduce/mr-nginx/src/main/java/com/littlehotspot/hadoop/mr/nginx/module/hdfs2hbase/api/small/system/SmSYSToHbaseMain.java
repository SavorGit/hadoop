...
import com.littlehotspot.hadoop.mr.nginx.module.hdfs2hbase.api.small.download.SmDlToHbase;
...
public class SmSYSToHbaseMain {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ToolRunner.run(conf, new SmSYSToHbase(), args);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
