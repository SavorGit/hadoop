...
import com.littlehotspot.hadoop.mr.nginx.module.hdfs2hbase.api.mobilelog.MobileLogHdfs;
 ...
 */
public class ContentToHdfsMain {
...
//        }
        ...
        try {
            ToolRunner.run(conf, new ContentLogHdfs(), args);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
