...
import com.littlehotspot.hadoop.mr.nginx.module.hdfs2hbase.api.sad.month.SadMonthReducer;
 ...
 */
public class SadYearScheduler extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        try {
            ...
            job.setReducerClass(SadYearReducer.class);
