 ...
 * 手机日志
 */
public class ContentLogHdfs extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        try {
            ...
            Job job = Job.getInstance(this.getConf(), ContentLogHdfs.class.getSimpleName());
            job.setJarByClass(ContentLogHdfs.class);
