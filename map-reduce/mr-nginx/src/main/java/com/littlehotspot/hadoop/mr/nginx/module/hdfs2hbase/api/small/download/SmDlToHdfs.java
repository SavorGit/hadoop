 ...
 */
public class SmDlToHdfs extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        try {
            ...
            Job job = Job.getInstance(this.getConf(), SmDlToHdfs.class.getSimpleName());
            job.setJarByClass(SmDlToHdfs.class);

            /**作业输入*/
            Path inputPath = new Path(hdfsInputPath);
            FileInputFormat.setInputPaths(job, inputPath);
            job.setMapperClass(DownloadHdfsMapper.class);
    ...
    private static class DownloadHdfsMapper extends Mapper<LongWritable, Text, Text, Text> {
        @Override
