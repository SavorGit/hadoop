...
import com.littlehotspot.hadoop.mr.nginx.module.hdfs2hbase.api.sad.yesterday.SadYesterdayReducer;
 ...
 */
public class SadMonthScheduler extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        try {
            ...
            job.setReducerClass(SadMonthReducer.class);
