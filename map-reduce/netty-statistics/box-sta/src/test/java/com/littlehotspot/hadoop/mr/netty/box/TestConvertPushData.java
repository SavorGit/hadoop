...
public class TestConvertPushData {
    ...
    public void testHelp() {
        try {
            String[] args = {"-h"};
            ConvertPushData.Main.main(args);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void testDefault() {
        try {
            String[] args = {"-jn=test job", "-i", "E:\\hadoop-data\\source\\push", "-o=E:\\hadoop-data\\export\\" + System.currentTimeMillis()};
            ConvertPushData.Main.main(args);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void testDefaultLocal() {
        try {
            String[] args = {"-jn=test job", "--verbose", "-i", "E:\\hadoop-data\\source\\push", "-o=E:\\hadoop-data\\export\\" + System.currentTimeMillis()};
