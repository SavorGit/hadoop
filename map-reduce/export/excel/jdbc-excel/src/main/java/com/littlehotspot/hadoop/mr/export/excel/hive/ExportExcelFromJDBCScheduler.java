...
import net.lizhaoweb.spring.hadoop.commons.mrcce.db.HiveInputFormat;
import net.lizhaoweb.spring.hadoop.commons.mrcce.db.SimpleDataWritable;
import net.lizhaoweb.spring.hadoop.commons.mrcce.excel.ExcelFileOutputFormat;
